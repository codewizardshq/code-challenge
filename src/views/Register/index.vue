			...
			<v-card flat class="mt-12">
				...
				<v-stepper v-model="stepperIndex">
					<v-stepper-header class="elevation-0">
						<v-stepper-step :complete="stepperIndex > 1" step="1">Account Details</v-stepper-step>

						<v-divider></v-divider>

						<v-stepper-step :complete="stepperIndex > 2" step="2">Student Details</v-stepper-step>
